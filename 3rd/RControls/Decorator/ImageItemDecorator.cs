...
namespace RControls.Decorator
{
	public class ImageItemDecorator : Control
	{
		...
		public static readonly DependencyProperty ShowDecoratorProperty =
			DependencyProperty.Register("ShowDecorator", typeof(bool), typeof(ImageItemDecorator),
			new FrameworkPropertyMetadata(false, new PropertyChangedCallback(ShowDecoratorProperty_Changed)));
		#endregion

		public ImageItemDecorator()
		{
		...
		{
			ImageItemDecorator decorator = (ImageItemDecorator)d;
